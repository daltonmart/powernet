...
public class PEstructuraArchivo implements IPEstructuraArchivo{
    ...
    public void escribirPersistenciaEstructuraArchivos( String nombreArchivo,String nombre, int tipo, String direccion, int permiso, String duenio, String grupo, int tamanio, String fechayhora, String contenido) {
        ...
        cadenaDatos=nombre+" ; "+stipo+" ; "+direccion+" ; "+spermiso+" ; "+duenio+" ; "+grupo+" ; "+ tamanio+" ; "+fechayhora+" ; "+contenido;
    ...
    public void verPersistenciaEstructuraArchivos(EstructuraArchivos listaArchivos, String nombreArchivo){
        ...
        try{
            ...
            while ((filaLeidaArchivo = brEA.readLine())!= null){
                ...
                tamanio = Integer.valueOf(cadenaSeparada[6]);
                DataArchivo a= new DataArchivo(cadenaSeparada[0],tipo,cadenaSeparada[2],permiso,cadenaSeparada[4],cadenaSeparada[5], tamanio, cadenaSeparada[7], cadenaSeparada[8]);
